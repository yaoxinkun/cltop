...
<html>
<head>
    <title>Welcome to clcheckout</title>
    <link rel="stylesheet" href="<c:url value="/static/clcheckout-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "clcheckout" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/clcheckout-items.xml</b> - here you can model your items</li>
            <li><b>resources/clcheckout-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/clcheckout-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/clcheckout-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/clcheckout-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
