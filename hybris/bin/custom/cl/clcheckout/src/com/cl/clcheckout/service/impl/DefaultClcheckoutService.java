...
public class DefaultClcheckoutService implements ClcheckoutService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultClcheckoutService.class);
	...
	{
		return DefaultClcheckoutService.class.getResourceAsStream("/clcheckout/sap-hybris-platform.png");
	}
