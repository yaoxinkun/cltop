 ...
 */
package com.cl.core.constants;

/**
 * Global class for all ClCore constants. You can add global constants for your extension into this class.
 */
public final class ClCoreConstants extends GeneratedClCoreConstants
{
	public static final String EXTENSIONNAME = "clcore";


	private ClCoreConstants()
	{
		//empty
	}
