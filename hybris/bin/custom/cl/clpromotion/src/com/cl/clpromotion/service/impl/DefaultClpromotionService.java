 ...
 */
package com.cl.clpromotion.service.impl;
...
public class DefaultClpromotionService implements ClpromotionService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultClpromotionService.class);
	...
	{
		return DefaultClpromotionService.class.getResourceAsStream("/clpromotion/sap-hybris-platform.png");
	}
