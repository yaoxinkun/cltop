...
public class DefaultCloutboundwebserviceService implements CloutboundwebserviceService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCloutboundwebserviceService.class);
	...
	{
		return DefaultCloutboundwebserviceService.class.getResourceAsStream("/cloutboundwebservice/sap-hybris-platform.png");
	}
