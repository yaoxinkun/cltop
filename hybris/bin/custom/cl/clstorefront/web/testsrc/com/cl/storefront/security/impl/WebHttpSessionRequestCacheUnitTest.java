...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/clstorefront/electronics/en",
						"https://electronics.local:9002/clstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/clstorefront/electronics/en",
						"https://electronics.local:9002/clstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/clstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/clstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/clstorefront/electronics/en",
						"https://electronics.local:9002/clstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/clstorefront",
						"https://electronics.local:9002/clstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/clstorefront",
						"https://electronics.local:9002/clstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/clstorefront/electronics/en",
						"https://electronics.local:9002/clstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
