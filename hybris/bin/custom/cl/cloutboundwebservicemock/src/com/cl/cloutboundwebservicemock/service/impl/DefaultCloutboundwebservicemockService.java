...
public class DefaultCloutboundwebservicemockService implements CloutboundwebservicemockService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCloutboundwebservicemockService.class);
	...
	{
		return DefaultCloutboundwebservicemockService.class.getResourceAsStream("/cloutboundwebservicemock/sap-hybris-platform.png");
	}
