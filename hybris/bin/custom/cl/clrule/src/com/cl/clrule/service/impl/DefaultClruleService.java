...
public class DefaultClruleService implements ClruleService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultClruleService.class);
	...
	{
		return DefaultClruleService.class.getResourceAsStream("/clrule/sap-hybris-platform.png");
	}
