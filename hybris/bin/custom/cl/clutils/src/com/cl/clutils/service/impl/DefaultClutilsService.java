...
public class DefaultClutilsService implements ClutilsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultClutilsService.class);
	...
	{
		return DefaultClutilsService.class.getResourceAsStream("/clutils/sap-hybris-platform.png");
	}
