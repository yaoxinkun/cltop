 ...
 */
package com.cl.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(ClFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ClFulfilmentProcessConstants.PARENT_PROCESS);
