...
public class DefaultClcronjobService implements ClcronjobService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultClcronjobService.class);
	...
	{
		return DefaultClcronjobService.class.getResourceAsStream("/clcronjob/sap-hybris-platform.png");
	}
