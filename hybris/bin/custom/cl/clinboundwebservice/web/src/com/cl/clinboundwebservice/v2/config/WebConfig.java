 ...
 */
package com.cl.clinboundwebservice.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.cl.clinboundwebservice.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "clinboundwebservice.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "clinboundwebservice.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "clinboundwebservice.oauth2.tokenUrl";

	private static final String DESC = "clinboundwebservice.v2.description";
	private static final String TITLE = "clinboundwebservice.v2.title";
	private static final String VERSION = "clinboundwebservice.v2.version";
