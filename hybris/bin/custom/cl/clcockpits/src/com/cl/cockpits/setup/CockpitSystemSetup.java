...
import com.cl.cockpits.constants.ClCockpitsConstants;
 ...
 */
@SystemSetup(extension = ClCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(ClCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(ClCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						ClCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/clcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
